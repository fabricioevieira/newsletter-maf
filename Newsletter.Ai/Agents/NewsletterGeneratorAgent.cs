...
{
    private const string _agentName = "NewsletterGeneratorAgent";
    private const string _prompt = "Gere um conteúdo para o newsletter com base no arquivo JSON fornecido.";
    private const float _temperature = 0.7f;

    public async Task<string> ExecuteAsync(IEnumerable<Article> data, CancellationToken cancellationToken)
    {
        ...
        var agent = client
            ...
            {
                Name = _agentName,
                Description = "Agente especializado em gerar conteúdo para newsletters.",
                ChatOptions = new()
                {
        ...
        logger.LogInformation("Newsletter content generated successfully.");
